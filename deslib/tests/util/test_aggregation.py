...
# These receives the matrix with the supports given for each class and returns the class labels (max score)

# Test example taken from Kuncheva's book: Combining pattern classifiers


example_kuncheva = np.array([[0.1, 0.5, 0.4], [0.0, 0.0, 1.0], [0.4, 0.3, 0.4], [0.2, 0.7, 0.1], [0.1, 0.8, 0.2]])
