...
from deslib.tests.examples_test import (create_pool_all_agree,
...
# This experiment should raise an error since we have 3 base classifiers and
# 4 weights.
...
# These routines calculates the matrix with the supports given for each class
# for each base classifier and them
...
# These receives the matrix with the supports given for each class and returns
# the class labels (max score)
