...
def test_kne_proba():
    ...
    expected = np.load('./expected_values/kne_proba_DFP.npy')
...
def test_desp_proba():
    ...
    expected = np.load('./expected_values/desp_proba_DFP.npy')
    assert np.allclose(probas, expected)
...
def test_ola_proba():
    ...
    expected = np.load('./expected_values/ola_proba_DFP.npy')
    assert np.allclose(probas, expected)
