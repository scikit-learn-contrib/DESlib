...
from pythonds.tests.examples_test import create_pool_all_agree, create_base_classifier, create_pool_classifiers
from pythonds.util.aggregation import majority_voting, weighted_majority_voting, predict_proba_ensemble, \
