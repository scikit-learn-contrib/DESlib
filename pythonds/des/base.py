...
class DES(DS):
    ...
    Warning: This class should not be instanciated directly, use derived classes instead.
    ...
    def __init__(self, pool_classifiers, k=7, DFP=False, with_IH=False, safe_k=None, IH_rate=0.30, aknn=False,
        ...
        super(DES, self).__init__(pool_classifiers, k, DFP=DFP, with_IH=with_IH, safe_k=safe_k, IH_rate=IH_rate, aknn=aknn)
        version.lower()
    ...
    def classify_instance(self, query):
        ...
        in the final decision are weighted according to their estimated competence level. The weighted majority voring
