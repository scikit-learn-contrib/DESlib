"""
The :mod:`pythonds.des` provides a set of key dynamic ensemble selection algorithms (DES). DES techniques by default
...
from .probabilistic import Probabilistic, RRC, Entropy, Exponential, DESKL, MinimumDifference
